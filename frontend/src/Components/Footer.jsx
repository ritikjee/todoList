...
function Footer() {
  return (
    <>
    <footer className="footer footer-center mt-10 p-10 bg-neutral text-primary-content">
  <aside>
    ...
    <p className="font-bold">
      Made with love by <br/>❤️Ritik Jha❤️
    </p> 
    <p>Copyright © 2023 - All right reserved</p>
  </aside> 
  <nav>
    <div className="grid grid-flow-col gap-4">
      {/* <Link to='/'><BsFacebook className='text-3xl'/></Link>
      <Link to='https://www.instagram.com/_ritikjha_'><AiFillInstagram className='text-3xl'/></Link>
      <Link to='/'><AiFillLinkedin className='text-3xl'/></Link>
      <Link to='/'><AiFillTwitterCircle className='text-3xl'/></Link>
      <Link to='https://github.com/ritikjee/'><BsGithub className='text-3xl'/></Link> */}
      {/* fix */}
      </div>
  </nav>
</footer>
